...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2025 at 05:48 PM
...
--
ALTER TABLE `admin_tbl`
  ADD CONSTRAINT `fk_users_admin` FOREIGN KEY (`user_id`) REFERENCES `qcu_ims`.`users_tbl` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `attendance_tracking_tbl`
--
ALTER TABLE `attendance_tracking_tbl`
  ADD CONSTRAINT `fk_interns_attendance_tracking` FOREIGN KEY (`intern_id`) REFERENCES `qcu_ims`.`interns_tbl` (`intern_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `daily_accomplishment_tbl`
--
ALTER TABLE `daily_accomplishment_tbl`
  ADD CONSTRAINT `fk_interns_daily_accomplishment` FOREIGN KEY (`intern_id`) REFERENCES `qcu_ims`.`interns_tbl` (`intern_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `employers_tbl`
--
ALTER TABLE `employers_tbl`
  ADD CONSTRAINT `fk_companies_employers` FOREIGN KEY (`company_id`) REFERENCES `qcu_ims`.`companies_tbl` (`company_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_users_employers` FOREIGN KEY (`user_id`) REFERENCES `qcu_ims`.`users_tbl` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `faculties_tbl`
--
ALTER TABLE `faculties_tbl`
  ADD CONSTRAINT `fk_faculties_users` FOREIGN KEY (`user_id`) REFERENCES `qcu_ims`.`users_tbl` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `interns_tbl`
--
ALTER TABLE `interns_tbl`
  ADD CONSTRAINT `fk_users_interns` FOREIGN KEY (`user_id`) REFERENCES `qcu_ims`.`users_tbl` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `intern_requirements_submission_tbl`
--
ALTER TABLE `intern_requirements_submission_tbl`
  ADD CONSTRAINT `fk_interns_irs` FOREIGN KEY (`intern_id`) REFERENCES `qcu_ims`.`interns_tbl` (`intern_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_requirements_irs` FOREIGN KEY (`requirement_id`) REFERENCES `qcu_ims`.`internship_requirements_tbl` (`requirement_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
